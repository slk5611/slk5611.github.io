  ...
  const repos = [
    {
      ...
      language: "TypeScript",
      langColor: "#3178C6",
      url: "https://github.com/slk5611/node-api-boilerplate",
    },
    {
      name: "async-batch-processor",
      description: "Efficient batch processing library for Node.js applications",
      stars: 156,
      language: "JavaScript",
      langColor: "#F7DF1E",
      url: "https://github.com/slk5611/async-batch-processor",
    },
    {
      name: "microservice-toolkit",
      description: "Essential tools and utilities for building microservices",
      stars: 189,
      language: "TypeScript",
      langColor: "#3178C6",
      url: "https://github.com/slk5611/microservice-toolkit",
    },
    {
      name: "express-middleware-suite",
      description: "Collection of useful Express.js middleware components",
      stars: 98,
      language: "JavaScript",
      langColor: "#F7DF1E",
      url: "https://github.com/slk5611/express-middleware-suite",
    },
  ]
